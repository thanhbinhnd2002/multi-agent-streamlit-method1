...
MAX_ITER = 10  # Số lần lặp tối đa để mô hình hội tụ
TOL = 1e-3  # Sai số hội tụ
...
def run_simulation(G, EPSILON, DELTA, N_BETA):
...
def main():
    ...
    for EPSILON, DELTA, N_BETA in product(EPSILON_list, DELTA_list, N_BETA_list):
        ...
        for file in files:
            ...
            top_genes = run_simulation(G, EPSILON, DELTA, N_BETA)
