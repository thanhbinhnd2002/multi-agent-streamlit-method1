...
# ✅ Đọc tham số từ biến môi trường (cho phép chạy grid search)
INF = int(os.environ.get("INF", 10000))
...
N_BETA = int(os.environ.get("N_BETA", 3))
output_folder = os.environ.get("OUTPUT_FOLDER", f"Output_test/INF{INF}_EPS{EPSILON}_DELTA{DELTA}_ITER{MAX_ITER}_TOL{TOL}_NBETA{N_BETA}")
...
# ✅ B4: Gắn Beta vào đúng 1 node target
